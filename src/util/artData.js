export default {
  ...
  },
  {
    ...
    links: [{
      web: "https://www.artstation.com/calderg207",
      ig: "https://www.instagram.com/g_caldeart/",
      twitter: "https://twitter.com/Calderg207",
    },],
    titles: [{
      1: "Fever Dream",
      2: "Offering",
      3: "End will be Televised",
      4: "Ballerina",
      5: "Unicycle",
      6: "Hope",
   }],
    bio:
      "Self taught 3D Freelance artist from Costa Rica, attracted by intricate designs, astronauts and dark themes.",
  },
  {
    name: "Chissweetart",
    username: "Chissweetart",
    s3_folder: "chiss/",
    img_qty: "7",
    img_ext: "jpg",
    countryCode: "russia",
    links: [{
      web: "https://www.artstation.com/chissweetart",
      web2: "https://www.nftculture.com/nft-artist-interviews/nft-artist-interview-chissweetart/",
      web3: "https://www.youtube.com/watch?v=bRVYfRORPNA",
      twitter: "https://twitter.com/chissweetart",
    },],
    titles: [{
      1: "The Bleeding Heart is Bound",
      2: "It Calls",
      3: "Melancholy",
      4: "Fragile",
      5: "The Battered Soul",
    ...
    bio:
      "New to the NFT Art world. I've been a Graphic Artist, Photo Manipulator, Photographer, Painter, and sketch artist since I was very young. All my art is individual, unique, dark and surreal. I take pride in my work and I hope you all will enjoy what I make.",
  },
  {
    name: "Carlos Alcocer",
    username: "Calaveritas",
    s3_folder: "cala/",
    img_qty: "6",
    img_ext: "png",
    countryCode: "mexico",
    links: [{
      ig: "https://www.instagram.com/c13studio/",
      fb: "https://www.facebook.com/c13studio/",
      opensea: "https://opensea.io/collection/calaveritas-eth",
      rarible: "https://rarible.com/calaveritas",
      twitter: "https://twitter.com/calaveritas_eth",
    },],
    titles: [{
      1: "016 - A little bird landed on my shoulder",
      2: "Upside down",
      3: "Green",
      4: "012 - Florcar",
      5: "Left turn yield on yellow",
      6: "013 - The G.O.A.T.",
   }],
    bio:
      "Carlos Alcocer is an architect by profession and a aerial photographer by passion. Obsessed with the \"Calaverita\" culture, also known as Sugar Skull, set himself a goal of illustrating one skull per day at the start of the pandemic. At the same time he has taken advantage of this time to experiment with aerial photography and long exposure. This technique involves capturing light while the cameras's shutter is open for a long time allowing him to \"Paint with light\".",
  },
  {
    name: "Chris Saros",
    username: "Chris Saros",
    s3_folder: "saros/",
    img_qty: "7",
    img_ext: "jpg",
    countryCode: "switzerland",
    links: [{
      web: "https://www.csaros.com/",
      ig: "https://www.instagram.com/saroscollective/",
      foundation: "https://foundation.app/CSaros",
      showtime: "https://tryshowtime.com/csaros",
      hicetnunc: "https://www.hicetnunc.xyz/tz/tz1NHWt27kgaXCWVFuhADhUEMeE8gLqS4bm5",
      twitter: "https://twitter.com/c_saros",
    },],
    titles: [{
      1: "Public Domain",
      2: "The Awakening",
    ...
    bio:
      "I'm Chris Saros, a dark artist, freelancer & professional musician from Switzerland. I create through various media, but mainly focusing on 3d art since 2020. While never limiting my artistic expression all too much, death, darkness and/or a critical view on the current state of humanity is always present in my work. Art is my dialogue with freedom, my celebration of life and death & my preservation of sanity.",
  },
  {
    name: "Øyvind Engevik",
    username: "ENGWIND",
    ...
    countryCode: "norway",
    links: [{
      web: "https://engwindart.com/",
      ig: "https://www.instagram.com/engwind/",
      foundation: "https://foundation.app/@ENGWIND",
      knownorigin: "https://knownorigin.io/engwind",
      opensea: "https://opensea.io/ENGWIND-NFT-COLLECTIBLES",
      twitter: "https://twitter.com/engwind_art",
    },],
    titles: [{
      1: "Basement Stock Trader",
      2: "Fallen Space Station",
      3: "Cyber Mining",
      4: "Covid Mask",
      5: "Future of Tech",
      6: "High Speed Gold",
      7: "Panther P4000X",
      8: "China 2077",
      9: "Streamer of Tomorrow",
      10: "Canyon Porsche",
      11: "Taycan Beauty",
      12: "Welcome to my World",
   }],
    bio:
      "ENGWIND is a creative CG-Artist and freelancer from Norway, with 12 years experience and 5 years in the professional field who have worked with clients like, Bitcoin, MSI, Demi Lovato, Tony Hawk, Magnus Carlsen and many more. On the side ENGWIND loves to create digital art, something that lead him into NFT's.",
  },
  {
    name: "Eskalexia Bawks",
    username: "Eskalexia",
    s3_folder: "eska/",
    img_qty: "8",
    img_ext: "png",
    countryCode: "austria",
    links: [{
      twitter: "https://twitter.com/eskalexia",
    },],
    titles: [{
      1: "Monument to Harmony and Hope",
      2: "Monument to Harmony and Survival",
      3: "Anecte Zwei-Schatten - Punished by the Sun",
      4: "Velióle Bandolin - Corrupted by Mystery",
      5: "KNOWLEDGE BURNS AND BURNS",
      6: "Last Resort lest you forget",
      7: "Couldn’t be’nt me’nt?",
      8: "Cryptobeastsbasketbaskjaminboy",
   }],
    bio:
      "Eska is an artist, researcher and developer in mind, and a witch at heart. She revels in the forbidden, yearns for the frontiers of the fathomable, lurking; savoring the eerie and absurd facets of life and existence. She also likes to feed ducks in silence (so as not to disturb them).",
  },
  {
    name: "Andrew Parker",
    username: "Blu Suede",
    ...
    links: [{
      ig: "https://www.instagram.com/blu_suede/",
    },],
    titles: [{
      1: "",
      2: "",
    ...
    bio:
      "My name is Andrew Parker, I'm a 26 year old self taught Color Pencil artist specializing in portraiture and I'm also a Graphic Designer. I turn some of my art into digital pieces of art. I started my art career in 2014 with mediums like Watercolor and Acrylic then moved to Color Pencil and Digital Painting a back in 2019.",
  },
  ]
}
