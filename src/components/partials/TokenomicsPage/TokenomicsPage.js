          ...
          <div className="grid grid-cols-none md:grid-cols-10 gap-8">
            <div className="row-start-2 md:row-start-1 md:col-span-6 pr-5">
              ...
              <div className="text-white font-semibold">
                ...
                powered by the $MBREW token as will future partnerships. With a 
            ...
            <div className="grid grid-cols-none md:grid-cols-3 gap-8 mb-10 mt-10">
              <div className="col-span-2">
                ...
                <div className="text-white font-semibold text-sm">
                  20% of our TotalSupply will be reserved for marketing and strategic partnerships including potential celebrity "Brand Ambassadors".
                </div>
              </div>
              <div className="col-span-2">
                <div className="flex items-center mb-3 md:mb-0">
                ...
                <div className="text-white font-semibold text-sm">
                  10% of our TotalSupply will be reserved for external investors and fund-raising efforts, as/if needed. This will ensure the health and long-term viability of our token.
                </div>
              </div>
              <div className="col-span-2">
                <div className="flex items-center mb-3 md:mb-0">
                ...
                <div className="text-white font-semibold text-sm">
                  Token allocation for co-founders, team members and advisory board members will be capped at roughly 20% of the TotalSupply. 
                </div>
              </div>
            </div>
          </div>
